...
export default class NavNolog extends Component {
  render() {
    return (
      <header className="text-gray-600 body-font shadow-lg mb-8 fixed top-0 w-full z-10 bg-white">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <p className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
            ...
            <img
              alt="plugin"
              src="https://res.cloudinary.com/desug/image/upload/v1614658900/Book%20/pluginlogo_gnhbmk.png"
              srcSet
              className="h-12"
            />
            </Link>
          ...
          <Link to="/login">
            <button className="border-solid focus:outline-none hover:bg-gray-300 md:border-solid border-2 border-gray-400 rounded-full py-2 px-6 text-gray-400">
              Login
            </button>
            </Link>
          </p>
