    ...
    return (
      <>
        <div className="mx-10 pt-2 mt-28">
          <p className="font-sans text-xl font-semibold text-gray-500">
            Technology
          </p>
        </div>
            ...
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              <p>
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4"
                  src="https://res.cloudinary.com/desug/image/upload/v1614658860/Book%20/book6_gj4e1r.png"
                />
              </p>
              <div className="flex-grow sm:pl-5">
                <h2 className="title-font font-bold text-gray-700">
            ...
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              <p>
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4"
                src="https://res.cloudinary.com/desug/image/upload/v1613768450/Book%20/javascript_odkh3c.jpg"
                />
              </p>
              <div className="flex-grow sm:pl-5">
                <h2 className="title-font font-bold text-gray-700">
            ...
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              <p>
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4"
                  src="https://res.cloudinary.com/desug/image/upload/v1614658830/Book%20/book5_i8tmiw.jpg"
                />
              </p>
              <div className="flex-grow sm:pl-5">
                <h2 className="title-font font-bold text-gray-700">
            ...
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              <p>
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4"
                  src="https://res.cloudinary.com/desug/image/upload/v1613768454/Book%20/java_kbdc8n.jpg"
                />
              </p>
              <div className="flex-grow sm:pl-5">
                <h2 className="title-font font-bold text-gray-700">
            ...
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              <p>
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4"
                  src="https://res.cloudinary.com/desug/image/upload/v1614658754/Book%20/book2_gaxgmc.png"
                />
              </p>
              <div className="flex-grow sm:pl-5">
                <h2 className="title-font font-bold text-gray-700">
            ...
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              <p>
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4"
                  src="https://res.cloudinary.com/desug/image/upload/v1614658764/Book%20/book3_clh0kc.png"
                />
              </p>
              <div className="flex-grow sm:pl-5">
                <h2 className="title-font font-bold text-gray-700">
