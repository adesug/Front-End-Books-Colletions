    ...
    return (
      <div className="flex flex-wrap bg-white w-full h-screen mt-28">
        <div className="w-9/12 bg-white rounded p-3">
          <span className="inline-block font-semibold text-xl text-gray-700 ml-5 lg:ml-20 md:ml-12 sm:ml-8 pb-4">
            Browser
          </span>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a
                ...
                className="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium focus:shadow-outline"
              >
                <span>
