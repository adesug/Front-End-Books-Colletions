                ...
                <div className="container mx-auto px-4 py-2 md:py-10">
                  <div className="mb-5 w-64">
                    ...
                    <div className="relative pb-28">
                      ...
                      <input type="text" readOnly x-model="datepickerValue" click="showDatepicker = !showDatepicker" keydown="showDatepicker = false" className="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Select date" />
                      <div className="absolute top-0 right-0 px-3 py-2">
                        <svg className="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <div className="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0" style={{width: '17rem'}} x-show="showDatepicker" click="showDatepicker = false">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <div>
                            <button type="button" className="transition ease-in-out duration-100 inline-flex cursor-pointer hover:bg-gray-200 p-1 rounded-full" class="{'cursor-not-allowed opacity-25': month == 0 }" disabled="month == 0 ? true : false" click="month--; getNoOfDays()">
                              <svg className="h-6 w-6 text-gray-500 inline-flex" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                              </svg>  
                            </button>
                            <button type="button" className="transition ease-in-out duration-100 inline-flex cursor-pointer hover:bg-gray-200 p-1 rounded-full" class="{'cursor-not-allowed opacity-25': month == 11 }" disabled="month == 11 ? true : false" click="month++; getNoOfDays()">
                              <svg className="h-6 w-6 text-gray-500 inline-flex" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="p-12 md:w-2/3 flex flex-col items-start">
              ...
              <div className="container px-5 py-12 mx-auto">
                ...
                <div className="flex justify-end mt-6">
                  ...
                  <button className="text-white bg-blue-400 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded-full text-lg">Send</button>
